...
require (
	...
	github.com/ethereum/go-ethereum v1.16.3-0.20260127120535-181a3ae9e0d6
...
replace github.com/ethereum/go-ethereum => github.com/MariusVanDerWijden/go-ethereum v0.0.0-20260216171241-de246ab0ccea
