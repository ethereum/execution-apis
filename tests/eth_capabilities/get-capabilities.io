...
if (r.head.number !== "0x36")
    throw new Error("incorrect head.number in response (want 0x36)");
if (r.head.hash !== "0xd226371d0b1551adb03fb52b71f08e3e11247fe9b1af994768af8cdaa8e7dcd7")
    throw new Error("incorrect head.hash in response (want 0xd226371d0b1551adb03fb52b71f08e3e11247fe9b1af994768af8cdaa8e7dcd7)");
